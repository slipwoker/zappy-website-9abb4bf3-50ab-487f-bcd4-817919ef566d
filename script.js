document.addEventListener('DOMContentLoaded', function () {
  ...
  function initScrollAnimations() {
    const candidates = document.querySelectorAll(
      ...
      '.feature, .card, .section-content, .hero-content, ' +
      '.testimonial, .pricing-card, .team-member, .service-item'
    );
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '9abb4bf3-50ab-487f-bcd4-817919ef566d',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '9abb4bf3-50ab-487f-bcd4-817919ef566d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9abb4bf3-50ab-487f-bcd4-817919ef566d';
